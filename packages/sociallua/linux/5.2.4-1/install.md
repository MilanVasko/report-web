# Report for 'install lua 5.2.4-1 sociallua'
...
- **sociallua 1.0-1**
    - **remote:** git://github.com/LuaDist-testing/sociallua.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.2.4-1/tmp/sociallua 1.0-1
