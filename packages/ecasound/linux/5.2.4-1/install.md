# Report for 'install lua 5.2.4-1 ecasound'
...
- **ecasound 0.3-0**
    - **remote:** git://github.com/LuaDist-testing/ecasound.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.2.4-1/tmp/ecasound 0.3-0
