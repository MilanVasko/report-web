# Report for 'install lua 5.3.2 mirrorfs'
...
- **mirrorfs 1.0-1**
    - **remote:** git://github.com/LuaDist-testing/mirrorfs.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/mirrorfs 1.0-1
