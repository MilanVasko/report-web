# Report for 'install lua 5.3.2 wsapi-fcgi'
...
- **wsapi-fcgi 1.7-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/wsapi-fcgi 1.7-1
...
### wsapi-fcgi 1.7-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/wsapi-fcgi 1.7-1/wsapi-fcgi-1.7-1.rockspec'
- Generated CMake file in '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/wsapi-fcgi 1.7-1'
- Building into '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/wsapi-fcgi 1.7-1-build'
- **CMake Variables:**
    - `CMAKE_BUILD_WITH_INSTALL_RPATH` = FALSE
    - `CMAKE_INCLUDE_PATH` = ;/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/include
    - `CMAKE_INSTALL_NAME_DIR` = @executable_path/../lib
    ...
    - `INSTALL_LMOD` = lib/lua
    - `INSTALL_SHARE` = share
- **Error:** Error building package 'wsapi-fcgi 1.7-1': Could not build with CMake in directory '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/wsapi-fcgi 1.7-1-build'
stdout:
Scanning dependencies of target lfcgi
[ 50%] Building C object CMakeFiles/lfcgi.dir/src/fastcgi/lfcgi.c.o

stderr:
/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/wsapi-fcgi 1.7-1/src/fastcgi/lfcgi.c:8:24: fatal error: fcgi_stdio.h: No such file or directory
