# Report for 'install lua 5.1.5-1 lua2json'
...
- **lua2json 0.1.1-1**
    - **remote:** git://github.com/LuaDist-testing/lua2json.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/lua2json 0.1.1-1
