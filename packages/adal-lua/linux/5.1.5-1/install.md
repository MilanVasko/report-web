# Report for 'install lua 5.1.5-1 adal-lua'
...
- **adal-lua 0.0.2-1**
    - **remote:** git://github.com/LuaDist-testing/adal-lua.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/adal-lua 0.0.2-1
