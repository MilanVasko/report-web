# Report for 'install lua 5.1.5-1 stuart-ml'
...
- **CMake Variables:**
    ...
    - `INSTALL_LMOD` = lib/lua
    - `INSTALL_SHARE` = share
- Executing 'cd "/home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/stuart 0.1.5-9-build" && cmake -P cmake_install.cmake'
