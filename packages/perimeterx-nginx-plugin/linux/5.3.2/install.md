# Report for 'install lua 5.3.2 perimeterx-nginx-plugin'
...
- **lua-resty-nettle 0.105-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/lua-resty-nettle 0.105-1
- **luasocket 3.0rc1-2**
...
- **perimeterx-nginx-plugin 3.3-0**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/perimeterx-nginx-plugin 3.3-0
...
### lua-resty-nettle 0.105-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/lua-resty-nettle 0.105-1/lua-resty-nettle-0.105-1.rockspec'
- Generated CMake file in '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/lua-resty-nettle 0.105-1'
- Building into '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/lua-resty-nettle 0.105-1-build'
- **CMake Variables:**
    - `CMAKE_BUILD_WITH_INSTALL_RPATH` = FALSE
    - `CMAKE_INCLUDE_PATH` = ;/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/include
    - `CMAKE_INSTALL_NAME_DIR` = @executable_path/../lib
    ...
    - `INSTALL_LMOD` = lib/lua
    - `INSTALL_SHARE` = share
- Executing 'cd "/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/lua-resty-nettle 0.105-1-build" && cmake -P cmake_install.cmake'
- Removing '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/lua-resty-nettle 0.105-1'
- Removing '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/lua-resty-nettle 0.105-1-build'
...
### perimeterx-nginx-plugin 3.3-0
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/perimeterx-nginx-plugin 3.3-0/perimeterx-nginx-plugin-3.3-0.rockspec'
