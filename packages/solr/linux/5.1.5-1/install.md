# Report for 'install lua 5.1.5-1 solr'
...
- **solr 0.2-1**
    - **remote:** git://github.com/LuaDist-testing/solr.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/solr 0.2-1
