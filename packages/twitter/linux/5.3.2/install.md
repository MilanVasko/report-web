# Report for 'install lua 5.3.2 twitter'
...
- **json4lua 0.9.30-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/json4lua 0.9.30-1
- **luasocket 3.0rc1-2**
...
- **oauth 0.0.4-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/oauth 0.0.4-1
- **twitter 1.0.0-1**
    - **remote:** git://github.com/LuaDist-testing/twitter.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/twitter 1.0.0-1
