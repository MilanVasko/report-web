# Report for 'install lua 5.3.2 pash'
...
- **templet 1.0.2-1**
    - **remote:** git://github.com/LuaDist-testing/templet.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/templet 1.0.2-1
- **inspect 3.1.1-0**
...
- **pash 1.0-1**
    - **remote:** git://github.com/LuaDist-testing/pash.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/pash 1.0-1
...
### templet 1.0.2-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.3.2/tmp/templet 1.0.2-1/templet-1.0.2-1.rockspec'
