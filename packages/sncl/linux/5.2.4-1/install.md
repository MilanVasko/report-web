# Report for 'install lua 5.2.4-1 sncl'
...
- **lyaml 6.2.2-1**
    - **remote:** git://github.com/LuaDist-testing/lyaml.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.2.4-1/tmp/lyaml 6.2.2-1
- **sncl 1.0-0**
    - **remote:** git://github.com/LuaDist-testing/sncl.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.2.4-1/tmp/sncl 1.0-0
...
### lyaml 6.2.2-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.2.4-1/tmp/lyaml 6.2.2-1/lyaml-6.2.2-1.rockspec'
- **Error:** Could not generate cmake commands for package 'lyaml 6.2.2-1': Unhandled rockspec build type: "command"
