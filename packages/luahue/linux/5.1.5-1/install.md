# Report for 'install lua 5.1.5-1 luahue'
...
- **luahue 1.0-1**
    - **remote:** git://github.com/LuaDist-testing/luahue.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/luahue 1.0-1
