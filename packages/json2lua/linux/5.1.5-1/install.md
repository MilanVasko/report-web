# Report for 'install lua 5.1.5-1 json2lua'
...
- **luajson 1.3.4-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/luajson 1.3.4-1
- **lua-nucleo 1.0.0-1**
...
- **json2lua 0.3.3-1**
    - **remote:** git://github.com/LuaDist-testing/json2lua.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/json2lua 0.3.3-1
...
### luajson 1.3.4-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_install/lua 5.1.5-1/tmp/luajson 1.3.4-1/luajson-1.3.4-1.rockspec'
